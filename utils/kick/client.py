...
class KickClient:
    ...
    async def _get_session(self) -> aiohttp.ClientSession:
        """Reusa una única sesión (con su pool de conexiones/keep-alive) para
        toda la vida del cliente, en vez de pagar un handshake TCP+TLS nuevo
        en cada request — send_chat_message se llama en cada respuesta de
        comando, así que esto es un hot path."""
